...
from src.sigmund.extensions import CLASSIFICATION_RANDOM_FOREST, FEATURE_VECTOR


class RandomForest(Component):
    """
    Performs random forest on a feature vector and prints results
    """
    ...
    def __init__(self,
        ...
        self.output: Extension = output or CLASSIFICATION_RANDOM_FOREST
        self.voting = voting
        ...
        super().__init__(
            f"{RandomForest.__name__} for {self.inputs}",
                ...
                if not self.evaluate_model:
                    ...
                    if self.save_model:
                        ...
                        pkl_filename = os.path.join(
                            self.model_path, "random_forest_binary.pkl")
            ...
            if not self.cross_validate:
                ...
                if not self.evaluate_model:
                    ...
                    if self.save_model:
                        ...
                        pkl_filename = os.path.join(
                            self.model_path, "random_forest_hamilton.pkl")
                        with open(pkl_filename, 'wb') as file:
                            pickle.dump(classifier, file)
